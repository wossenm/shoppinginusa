...
abstract class KunenaForum {
	...
	protected static function buildVersion() {
		if ('3.0.1' == '@' . 'kunenaversion' . '@') {
			...
			self::$version = strtoupper ( '3.0.1' );
		}
		self::$version_major = substr(self::$version, 0, 3);
		self::$version_date = ('2013-06-29' == '@' . 'kunenaversiondate' . '@') ? JFactory::getDate()->format('Y-m-d') : '2013-06-29';
		self::$version_name = ('Noordwijkerhout' == '@' . 'kunenaversionname' . '@') ? 'Git Repository' : 'Noordwijkerhout';
	}
}
