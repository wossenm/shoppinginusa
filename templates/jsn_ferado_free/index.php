	...
	?>
		...
		<div id="jsn-body">
			...
			<div id="jsn-content-top-below">
				<div id="jsn-pos-content-top-below">
					<jdoc:include type="modules" name="content-top-below" style="jsnmodule" class="jsn-innerhead" />
				</div>
			</div>
			<?php
				}
			...
			/*====== Show modules in position "content-top-below" ======*/
			if ($jsnutils->countModules('content-top-overbelow') > 0) {
			?>
			<div id="jsn-content-top-overbelow">
				<div id="jsn-pos-content-top-overbelow">
					<jdoc:include type="modules" name="content-top-overbelow" style="jsnmodule" />
				</div>
			</div>
			<?php
				}
			/*====== Show modules in position "content-top-full" ======*/
				if ($jsnutils->countModules('content-top-full') > 0) {
			?>
			<div id="jsn-content-top-full">
				<div id="jsn-pos-content-top-full">
					<jdoc:include type="modules" name="content-top-full" style="jsnmodule" class="jsn-innerhead" />
				</div>
			</div>
			<?php
				}
		...
		?>
			...
			<?php
				...
				if ($jsnutils->countModules('content-bottom-overbelow') > 0) {
			?>
				<div id="jsn-content-bottom-overbelow">
					<div id="jsn-content-bottom-overbelow-inner">
						<div id="jsn-pos-content-bottom-overbelow" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $jsnutils->countModules('content-bottom-overbelow'); ?> row-fluid">
							<jdoc:include type="modules" name="content-bottom-overbelow" style="jsnmodule" columnClass="span<?php echo ceil(12 / $jsnutils->countModules('content-bottom-overbelow')); ?>" />
						</div>
					</div>
				</div>
			<?php
