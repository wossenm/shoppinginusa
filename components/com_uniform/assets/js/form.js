        ...
        $.initJSNForm = function (formname) {
            ...
            function calculateTotal() {
                        ...
                        if ($(this).hasClass('payment-active')) {
                            $(this).find("input:checked").each(function () {
                                if ($(this).prop('checked')) {
                                    checkboxes += parseFloat($(this).attr('attr-price') * $(this).attr('attr-qty'));
                                }
                            });
                        }
                    }
                ...
                dropdownElements.each(function(){
                    if(! $(this).closest('.control-group').hasClass('hide')) {
                        if ($(this).hasClass('payment-active')) {
                            if (typeof $(this).find('option:selected').attr('attr-price') != 'undefined') {
                                if ($(this).find('option:selected').attr('attr-price') == '') {
                                    dropdown += 0;
                                }
                                else {
                                    dropdown += parseFloat($(this).find('option:selected').attr('attr-price') * $(this).find('option:selected').attr('attr-qty'));
                                }
                            }
                        }
                    }
                ...
                choicesElements.each(function(){
                    if(! $(this).closest('.control-group').hasClass('hide')) {
                        if ($(this).hasClass('payment-active')) {
                            $(this).find('input:checked').each(function () {
                                choices += parseFloat($(this).attr('attr-price') * $(this).attr('attr-qty'));
                            });
                        }
                        else {
                            choices += 0;
                    ...
                    if(! $(this).closest('.control-group').hasClass('hide')) {
                        if ($(this).hasClass('payment-active')) {
                            $(this).find('option:selected').each(function () {
                                list += parseFloat($(this).attr('attr-price') * $(this).attr('attr-qty'));
                            });
                        }
                    }
                });
                ...
                $.each(dataSettings, function (i, item) {
                    ...
                    if ($(selfInput).val() == i) {
                        if (item.showField) {
                            ...
                            $(formname).find(classShowField.join(",")).addClass(idField).show();
                        }
                        if (item.hideField) {
                            $.each(item.hideField, function (j, actionField) {
                                if (actionField) {
                            ...
                            $(formname).find(classHideField.join(",")).addClass(idField).hide();
                        }
                    }
                });
            }
