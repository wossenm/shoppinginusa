			...
			<div class="span6" id="mc-send-to-email">
				<fieldset id="send-to-email">
					...
					<div class="jsn-bootstrap emailsettings">
						...
						<input type="hidden" name="jform[email-settings][administrator][form_id]" value="<?php echo isset($_GET['form_id']) ? $_GET['form_id'] : ''; ?>" />
			...
			<div class="span6" id="mc-send-to-submitter">
				<fieldset id="email">
					...
					<div class="jsn-bootstrap emailsettings email-submiter">
						...
						<input type="hidden" name="jform[email-settings][submiter][form_id]" value="<?php echo isset($_GET['form_id']) ? $_GET['form_id'] : ''; ?>" />
