<?php
/**
 * 3.2.7     $Id: uniform.defines.php 19014 2012-11-28 04:48:56Z thailv $
 * @package     JSNUniform
 * @subpackage  Config
...
define('JSN_UNIFORM_VERSION', '3.2.7');
