                ...
                $(".mobilize-menu .link-menu-mobilize").each(function (){
                    if($(this).attr('data-type') === 'mobilize-menu'){
                        if($(this).attr("data-value") === ''){
                            var url = "index.php?option=com_mobilize&view=menus&layout=default&tmpl=component&jsnaction=update";
                    ...
                    if($(this).attr('data-type') === 'mobilize-search'){
                        if($(this).attr("data-value") === ''){
                            var url = "index.php?option=com_mobilize&view=modules&layout=default&tmpl=component&function=changeModuleMenuIcon&filter_client_id=0&filter_state=1&filter_module=mod_search&jsnaction=update&modulesAction=menu";
                            var strAttr = 'Search';
                    ...
                    if($(this).attr('data-type') === 'mobilize-login'){
                        if($(this).attr("data-value") === ''){
                            var url = "index.php?option=com_mobilize&view=modules&layout=default&tmpl=component&function=changeModuleMenuIcon&filter_client_id=0&filter_state=1&filter_module=mod_login&jsnaction=update&modulesAction=menu";
                            var strAttr = 'Login';
...
//                    self.dialogLoadStyleProfile($(this));
            ...
            loadFooter:function (){
                ...
                var url ='index.php?option=com_mobilize&view=positions&tmpl=component&function=jSelectPosition&filter_template=' + this.defaultTemplate + '&filter_type=template&filter_state=1';
                var createIframe = $("<iframe/>"+ url, {
                    "class":"hid",
                    "src":url,
                    height:600 * (90 / 100),
...
//            },
            ...
            changeLogo:function () {
                ...
                this.modalchangeLogo = new JSNModal({
                    ...
                    buttons:buttons,
                    height:parent.document.body.clientHeight * 0.55,
            ...
            dialogChangeMenus:function () {
                ...
                this.modalMobilize = new JSNModal({
                    frameId: frameId,
                    url:"index.php?option=com_mobilize&view=menus&layout=default&tmpl=component&jsnaction=update",
