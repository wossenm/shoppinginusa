    ...
    public function onAfterRender(){
    	...
    	if ($document instanceOf JDocumentHTML) {
	    	...
	    	if ($this->_application->isAdmin() && $this->_user->id > 0) {
				...
				if ($app->input->getVar('option', '') == 'com_poweradmin' && ($view == 'changeposition' || $view == 'rawmode' || $view == 'search' || $view == 'configuration' || $view == 'about' || $view == 'templates' || $view == 'positionlisting'))
				{
