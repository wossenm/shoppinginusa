...
//			}
			...
			var frame_url = 'index.php?widget=megamenu&action=render-element-form&rformat=raw&template=' + $('#jsn-tpl-name').val() + '&modal=yes&modal_type=element&shortcode=' + shortcode + '&style_id=' + $('#jsn-tpl-style-id').val();
