	...
	$.JSNTplMMShortcodeModuleSettings.prototype = {
		...
		renderModuleList: function(){
			...
			$.ajax({
				type: 'GET',
				dataType: 'html',
				url: 'index.php?widget=megamenu&action=get-module-list&shortcode=jsn_tpl_mm_module&start=' + start + '&rformat=raw&template=' + $('#jsn-tpl-name').val() + '&kword=' + encodeURIComponent($('#jsn-tpl-mm-element-module-input-search').val()),
		...
		getTotalModule: function(){
			...
			$.ajax({
				type: 'GET',
				dataType: 'html',
				url: 'index.php?widget=megamenu&action=get-total-module&shortcode=jsn_tpl_mm_module&start=' + start + '&rformat=json&template=' + $('#jsn-tpl-name').val() + '&kword=' + encodeURIComponent($('#jsn-tpl-mm-element-module-input-search').val()),
				success: function (response) {
