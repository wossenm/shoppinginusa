...
class JSNTplTemplateMegamenu
{
	 ...
	 * @return string
	 */
	public static function beginMegamenu()
	{
		return '<div class="jsn-tpl-megamenu-container jsn-tpl-bootstrap3"><ul class="jsn-tpl-megamenu menu-mainmenu" id="jsn-tpl-megamenu">';
	}
	 ...
	 * @return string
	 */
	public static function endMegamenu()
	{
		return '</ul></div>';
	}
