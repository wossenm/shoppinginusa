...
class JSNISFlowDisplay extends JObject
{
	...
	public function JSNISFlowDisplay() {}
	...
	public function standardLayout($args)
	{
		...
		foreach ($images as $image) {
			...
			$html .= '<div class="imageItem"><a '.$clickAction.' '.$openLinkIn.' title="'.$title.'" rev="'.$caption.'"><img width="'.$imgWidth.'" height="'.$imgHeight.'" src="'.$image->$imageSource.'" data-artist="'.$title.'" data-album="'.$desc.'" alt="' . $alt . '"/></a></div>';
		}
